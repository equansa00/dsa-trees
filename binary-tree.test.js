...
describe("serialize and deserialize", function() {
  ...
  it("serializes trees into strings", function() {
    expect(typeof BinaryTree.serialize(myTree.root)).toBe("string");
  });

  it("deserializes strings into BinaryTree objects", function() {
    let serialized = BinaryTree.serialize(myTree.root);
  ...
  it("reverses one another", function() {
    let serialized = BinaryTree.serialize(myTree.root);
    let deserializedTree = BinaryTree.deserialize(serialized);
    ...
    expect(isSameTree(deserializedTree.root, myTree.root)).toBe(true);
  });
